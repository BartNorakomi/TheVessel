...
PointerToChanges:
  incbin "..\grapx\RacingGame\nightstriker2Diff.SR5"
LenghtChanges:  equ $-PointerToChanges


LenghtXYData:
  ;amount,    x, y   (x/2+000 or x/2+128 (for the next line))   (y/2 + write access), data
...
ExamplePixelsThatChange:
db  119,119,119,119,119,119,               119,119,119
ExampleVramWriteAddresses:
...
VideoReplayer2:
  ...
  ld    hl,ExamplePixelsThatChange
  ld    c,$98
  exx
  ld    hl,ExampleVramWriteAddresses
  ld    c,$99
  ;set next x,y
  outi  ;upcode $ed $a3
  outi
  ;write 6 bytes to vram
  exx ;upcode $d9
  outi
  outi
  outi
