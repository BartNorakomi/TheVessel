# File paths
$image1Path = "nightstriker2Prepared.SR5"
$image2Path = "nightstriker2PreparedChanges.SR5"

$changedPixelsPath = "changedpixels.bin"
$addressesPath = "addresses.bin"
$outputInstructionsPath = "writeinstructions.bin"
